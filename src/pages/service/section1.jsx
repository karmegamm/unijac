        ...
        {service.map(({img1,head1,para1,img2,head2,para2})=>{
             return <div>
                    <div className='flex justify-center items-center md:flex-row  flex-col hovdiv mb-2'>
                        <img src={img1} className='z-20 my-2 md:my-0 w-[70%] xl:w-[60%] md:w-[35%] rounded-2xl transition-transform duration-500 hovimg' />
                    ...
                    <div className='flex justify-evenly items-center md:flex-row  flex-col-reverse hovdiv2'>
                        ...
                        <img src={img2} className='z-20 w-[70%] xl:w-[60%] md:w-[30%] rounded-2xl transition-transform duration-500 hovimg2' />
                    </div></div>     
        })}
      </div>
  </div>
